...
class KeyboardCallout_StandardCalloutServiceTests: XCTestCase {
    ...
    func testHapticFeedbackSettingGatesSelectionChangeFeedback() {
        let feedbackContext = FeedbackContext()
        let feedbackService = TestFeedbackService()
        service = .init(
            keyboardContext: context,
...
private final class TestFeedbackService: FeedbackService {
